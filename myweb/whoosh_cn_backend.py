...
'''
1.
将文件whoosh_backend.py（路径为：python安装路径\Lib\site-packages\haystack\backends\whoosh_backend.py）拷贝到 myweb/myweb 下
...
HAYSTACK_CONNECTIONS = {
    'default': {
        ...
        'PATH': os.path.join(os.path.dirname(__file__), 'whoosh_index'),    # 存放 Whoosh 索引文件的文件夹
    },
}
...
查找analyzer=StemmingAnalyzer()并替换为analyzer=ChineseAnalyzer(), 
