...
'''源码位置: 
    site-packages/haystack/templatetags/highlight.py
'''
...
class HighlightNode(template.Node):
    def __init__(
        self, text_block, query, html_tag=None, css_class=None, max_length=None, start_head=None
    ):
    ...
    def render(self, context):
        ...
        if (
            ...
            # change
            from .search_highlight import Highlighter
...
def myhighlight(parser, token):
    ...
    for bit in arg_bits:
        ...
        # ++
        if bit == "start_head":
            kwargs["start_head"] = next(arg_bits)
