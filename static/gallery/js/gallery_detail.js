 ...
 */
{
    ...
    class Grid {
        ...
        showContent() {
            ...
            // 设置 content 背景图片和标题
            this.DOM.content.style.backgroundImage = `url('${this.image}')`;
            ...
            this.animation = anime({
                ...
                easing: 'easeOutQuint',
                opacity: 0,
                translateX: anime.stagger(-3, {grid: this.gridDef, axis: 'x'}),
                delay: anime.stagger(50, {grid: this.gridDef})
            });
            this.animation.play();
            this.animation.finished.then(() => {
                this.DOM.el.classList.add('grid-wrap--hidden');  // 指针事件类
        ...
        showGrid() {
            ...
            this.animation = anime({
                ...
                opacity: [0,1],
                translateX: [0, 0],
                delay: anime.stagger(60, {grid: this.gridDef, from: this.pos})
            });
